...
def _normalize_indicator_item(d: dict) -> dict:
    ...
    return {
        ...
        "audit_points": d.get("audit_points", "") or "",
        "deduct_rules": d.get("deduct_rules", "") or d.get("deduction_rule", "") or "",
...
async def import_indicators(file: UploadFile = File(...),
    ...
    for item in items:
        ...
        ind = Indicator(
            ...
            audit_points=item.get("audit_points", ""),
            deduct_rules=item.get("deduct_rules", "") or item.get("deduction_rule", ""),
